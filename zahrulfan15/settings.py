"""
Django settings for zahrulfan15 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-wvi&g(=&yluf*yb(4@y6e6@=5!fihgqf!&-*y7ix)g(=zr_-81')
...
WSGI_APPLICATION = 'zahrulfan15.wsgi.application'
